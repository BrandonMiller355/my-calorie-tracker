export function WeeklyDeficit({
  ...
  return (
    <section className="weekly-deficit" aria-label="Weekly deficit">
      <div className="weekly-deficit-line">
        <span className="weekly-deficit-dot" aria-hidden="true" />
        <div className="weekly-deficit-label">Weekly deficit</div>
        <div
          className={`weekly-deficit-value${deficit < 0 ? ' weekly-deficit-value-negative' : ''}`}
        >
